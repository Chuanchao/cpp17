...
#ifndef ORDERTEST_CONFIG_H
#define ORDERTEST_CONFIG_H
...
/*
   ...
   ParseData structured config files
...
class Config {
public:
    /* ParseData config file 'configFile'. If the process environment
